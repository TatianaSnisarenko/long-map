...
public class LongMapImplTest {
    ...
    void values_happyPath() {
        ...
        expectedOne[20] = null;
        expectedOne[21] = null;
        List<String> valuesOne = map.values();
        assertThat(valuesOne.size()).isEqualTo(22);
        assertThat(valuesOne).containsOnly(expectedOne);
        LongStream.rangeClosed(1, 13).forEach(map::remove);
        String[] expectedTwo = Arrays.copyOfRange(expectedOne, 13, expectedOne.length);
        List<String> valuesTwo = map.values();
        assertThat(valuesTwo.size()).isEqualTo(9);
    ...
    void clear_happyPath() {
        ...
        assertThat(map.values().size()).isEqualTo(22);
        map.clear();
        assertThat(map.size()).isEqualTo(0);
        assertThat(map.keys()).isEmpty();
        assertThat(map.values()).isEmpty();
    ...
    void toString_happyPath() {
        de.comparus.opensource.longmap.LongMap<String> map = new de.comparus.opensource.longmap.LongMapImpl<>(String.class);
        LongStream.rangeClosed(1, 20).forEach(i -> map.put(i, "a" + i));
